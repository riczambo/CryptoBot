...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'Z:\Documenti\Test informatici\Python\CryptoBot_v2\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'Z:\Documenti\Test informatici\Python\CryptoBot_v2\venv\Scripts\deactivate.nu'
